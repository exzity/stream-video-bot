...
from bot.videoplayer import STREAM
from bot.videoplayer import ydl, group_call_factory
...
@Client.on_message(filters.command(["radio", f"radio@{USERNAME}"]) & filters.user(SUDO_USERS) | filters.private)
...
@Client.on_message(filters.command(["stopradio", f"stopradio@{USERNAME}"]) & filters.user(SUDO_USERS) | filters.private)
@authorized_users_only
